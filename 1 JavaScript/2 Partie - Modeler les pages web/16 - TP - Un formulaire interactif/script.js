...
// Fonctions de vérifications du formulaire, elles renvoient "true" si tous est ok.
...
// La fonction pour le prenom est le même que celle du nom;
...
check['age'] = function (){
  ...
  if(!isNaN(ageValue) && ageValue >= 5 && ageValue <= 75){
...
// Maintenant que tous est initialisé, on peut désactiver les "tooltips"
deactivatetooltips();